var createTextMateModule = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    function findWasmBinary() {
      return locateFile('tml-standard.wasm');
    }
    ...
    function assignWasmExports(wasmExports) {
      ___getTypeName = wasmExports['D'];
      _free = wasmExports['F'];
      _malloc = wasmExports['G'];
      ___trap = wasmExports['H'];
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createTextMateModule;
  module.exports.default = createTextMateModule;
} else if (typeof define === 'function' && define['amd']) define([], () => createTextMateModule);
